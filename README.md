...
The difference of this character sheet are as follows;
* Everything is on one page, you just scroll around
* DOES NOT HAVE AUTOMATIONS OR FUNCTIONING ROLL BUTTONS
* Health Status are quickly found on the top (except for radiation, injuries, and diseases)
* Damage Capacity and Stress Capacity checkboxes are limited to 6
* Character Avatar and Token are on the top as well for quicker identification
* Didn't include an age input because I tried to style this as close as possible to the actual character sheet of Twilight 2000 4th Edition, only to be set back by Roll20's limits 
* Specialties are repeated fieldsets and areon the very bottom because they tend to take a lot of space with their description and makes it irritating to have to scroll past them to get to the other stuff
* Weapons and Gear are all on repeated fieldsets as well so you can add and modify what items there are in your inventory
